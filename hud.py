...
class NeuronSprite:
    def __init__(self, x, y, batch): 
        ...
        self.node_value = Label(f"{x},{y}", x=x, y=y, color=(255,255,255, 255), font_size= 12, anchor_x= 'center', anchor_y='center',batch=batch) 
        ...
        def update(self, value):
            ...
            if value > 0:
                ...
                self.node_fill.color = int(value * 200), 0, 255
...
class Hud:
    def __init__(self, simulation_round, dimensions, batch):
        self.round_label = Label(f"Round: {simulation_round}", x=20, y=520, color=(0,0,255), batch=batch)
